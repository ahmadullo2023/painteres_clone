...
List<PinterestModel> pinterestFromJson(String str) =>
    List<PinterestModel>.from(json.decode(str));

String pinterestToJson(PinterestModel data) => json.encode(data.toJson());
